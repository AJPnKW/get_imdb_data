...
class Studio(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.btnHarvest = QtWidgets.QPushButton("1) Harvest âžœ Registry")
        self.btnFilter  = QtWidgets.QPushButton("2) Filter/Dedupe âžœ Curated")
        ...
        self.pickOut = QtWidgets.QPushButton("â€¦"); self.pickOut.setFixedWidth(36)
